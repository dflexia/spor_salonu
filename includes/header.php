    ...
    <nav class="navbar navbar-expand-lg navbar-dark mb-4">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="/modules/uye/uye_listele.php">
                            <i class="fas fa-users me-1"></i>Üyeler
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/modules/antrenor/antrenor_listele.php">
                            <i class="fas fa-user-tie me-1"></i>Antrenörler
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/modules/ders/ders_listele.php">
                            <i class="fas fa-calendar-alt me-1"></i>Dersler
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/modules/ekipman/ekipman_listele.php">
                            <i class="fas fa-dumbbell me-1"></i>Ekipmanlar
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/modules/uyelik_paketi/uyelik_paketi_listele.php">
